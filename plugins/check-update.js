...
cmd({
  ...
  try {
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/abdallahsalimjuma/DRAXEN-Ai';

    // Check update status
    let updateMessage = `✅ Your DRAXEN-Ai bot is up-to-date!`;
    if (localVersion !== latestVersion) {
      updateMessage = `🚀 Your DRAXEN-Ai bot is outdated!
...
Use *.update* to update.`;
    ...
    const statusMessage = `🌟 *Good ${new Date().getHours() < 12 ? 'Morning' : 'Night'}, ${pushname}!* 🌟\n\n` +
      ...
      `📝 *Changelog:*\n${latestChangelog}\n\n` +
      `⭐ *GitHub Repo:* ${githubRepo}\n👤 *Owner:* [DRAXEN²⁴⁰⁶](https://github.com/dullah255/DRAXEN-Ai)\n\n${updateMessage}\n\n🚀 *Hey! Don't forget to fork & star the repo!*`;
